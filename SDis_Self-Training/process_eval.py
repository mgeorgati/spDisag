...
import evaluating.calcKNN as calcKNN
import evaluating.evalResults as evalRs
from config import ROOT_DIR, ancillary_path, pop_path, year
from evaluating.correlation import corCSV
from evaluating.verifyMassPreserving import verifyMassPreserv
        ...
        for i in attr_value:
            ...
            if city == 'ams':
                evalFiles = [#ROOT_DIR + "/Results/{0}/apcnn/dissever01_RMSE_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_{1}.tif".format(city,i),
                    ...
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_00RBLF_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_{1}.tif".format(city,i),
                    ROOT_DIR + "/Results/{0}/apcnn/dissever01_00RBLFflipped_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_tr2008CLF_2018_ams_Dasy_16unet_10epochspi_2AIL20_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_CLF_2018_ams_Dasy_16unet_10epochspi_2AIL20_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_CLF_2018_ams_Dasy_16unet_10epochspi_2AIL21_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_CLF_2018_ams_Dasy_16unet_10epochspi_3AIL22_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_tr2008CLF_2018_ams_Dasy_16unet_10epochspi_2AIL21_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_tr2008CLF_2018_ams_Dasy_16unet_10epochspi_3AIL22_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_tr2008CLF_2018_ams_Dasy_16unet_10epochspi_2AIL24_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_CLF_2018_ams_Dasy_16unet_10epochspi_2AIL24_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_2008historicalCLF_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_2016historicalCLF_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_{1}.tif".format(city,i),
                ...
                districtPath = ancillary_path + '/{0}/adm/{0}_districts.geojson'.format(city)    
            ...
            if city == 'cph':
                evalFiles = [ROOT_DIR + "/Results/{0}/apcnn/dissever01_RMSEflipped_2018_{0}_Dasy_16unet_10epochspi_3AIL8_it10_{1}.tif".format(city,i),
                    ROOT_DIR + "/Results/{0}/apcnn/dissever01_CLFflipped_2018_{0}_Dasy_16unet_10epochspi_3AIL8_it10_{1}.tif".format(city,i),
                    ROOT_DIR + "/Results/{0}/apcnn/dissever01_RBLFflipped_2018_{0}_Dasy_16unet_10epochspi_3AIL8_it10_{1}.tif".format(city,i),
                    #ROOT_DIR + "/Results/{0}/apcnn/dissever01_RBLFflipped_2018_{0}_Dasy_16unet_10epochspi_3AIL8_it10_{1}.tif".format(city,i),
                    ...
                    #ROOT_DIR + "/Results/{0}/apcatbr/dissever01WIN_500_2018_{0}_DasyB_apcatbr_p[1]_3AIL8_27IL_it10_{1}.tif".format(city,i)
                    ]
                ...
                outputGT = ROOT_DIR + "/Evaluation/{1}_groundTruth/{0}_{1}_{2}.tif".format(year,city,i)
                # Required files for plotting
                polyPath = ROOT_DIR + "/Shapefiles/{1}/{0}_{1}.shp".format(year,city)
                districtPath = ancillary_path + '/{0}/adm/{0}_whole.gpkg'.format(city)     #geojson
                waterPath = ancillary_path + '{0}/corine/waterComb_{0}_CLC_2012_2018.tif'.format(city)
                invertArea = None #ancillary_path + '/{0}/adm/grootams_noAms.geojson'.format(city)
                
                outGT = ROOT_DIR + '/Evaluation/{1}_convolutions/conv_{0}_{1}_{2}.tif'.format(year,city,i)
                thres = [50, 100, 200, 500]
            ...
            if plot_evalMaps== "yes":
                evalPath = ROOT_DIR + "/Evaluation/{0}_{1}/".format(city, 'whole') #date
                if not os.path.exists(evalPath):
                    createFolder(evalPath)
                    
                exportPathGT = ROOT_DIR + "/Evaluation/{0}_GT/{0}_{1}/".format(city, 'whole') #date
            ...
            for k in thres:
                ...
                if plot_evalMaps_knn == "yes":
                    evalPath = ROOT_DIR + "/Evaluation/{0}_knnGF/{0}_{1}/".format(city, 'knn_whole') #date
                    if not os.path.exists(evalPath):
                        createFolder(evalPath)
            ...
            if plot_Matrices == "yes" :
                for x in range(len(evalFiles)):
                    ...
                    print(path, fileName)
                    exportPathGT = ROOT_DIR + "/Evaluation/{0}_GT/{0}_{1}/".format(city, 'whole')
                    evalPath = ROOT_DIR + "/Evaluation/{0}_{1}/".format(city, 'whole') #date
                    evalPathKNN = ROOT_DIR + "/Evaluation/{0}_knn/{0}_{1}/".format(city, 'knn_whole')
                    evalPathKNNgf = ROOT_DIR + "/Evaluation/{0}_knnGF/{0}_{1}/".format(city, 'knn_whole')
                    evalPathMatrices = ROOT_DIR + "/Evaluation/{0}_{1}/{2}".format(city, 'matrices', fileName)
                    ...
                    # Plot matrces
                    evalRs.createMatrices(evalPath, city, i, evalPathKNN, evalPathKNNgf, evalPathMatrices, exportPathGT, fileName, method, scatterPath=None)
