...
from plotting.createMatrix import plotMatrix
from plotting.createScatterPlot import histplot, scatterplot
...
from evaluating.evaluateFunctions import (Rsquared, mae_error, mape_error,
                                          percentage_error, residual,
                                          rmse_error)
...
def createMatrices(evalPath, city, attr_value, evalPathKNN, evalPathKNNgf, evalPathMatrices, exportPathGT, fileName, method, scatterPath=None):
    e= [evalPath + "/apcnn/div_dissever01_RMSEflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_mar_Grid.png".format(attr_value),
        evalPath + "/apcnn/div_dissever01_CLFflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_mar_Grid.png".format(attr_value),
        evalPath + "/apcnn/div_dissever01_00RBLFflipped_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_mar_Grid.png".format(attr_value),
        evalPath + "/apcatbr/div_dissever01WIESMN_500_2018_ams_DasyA_apcatbr_p[1]_12AIL12_12IL_it10_mar_Grid.png".format(attr_value),
        #evalPath + "/apcnn/div_dissever01_RMSEflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcnn/div_dissever01_CLFflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcnn/div_dissever01_00RBLFflipped_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcatbr/div_dissever01WIESMN_500_2018_ams_DasyA_apcatbr_p[1]_12AIL12_12IL_it10_tur_Grid.png".format(attr_value)
        ]
    path = os.path.dirname(os.path.dirname(evalPath)) + "/ams_matrices/mape_LFunctions_mar.png".format(attr_value)
    title = "Mean Absolute Percentage Error: mar".format(attr_value)
    plotMatrix(e, path, title) 
    
    e= [evalPath + "/apcnn/mae_dissever01_RMSEflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_mar_Grid.png".format(attr_value),
        evalPath + "/apcnn/mae_dissever01_CLFflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_mar_Grid.png".format(attr_value),
        evalPath + "/apcnn/mae_dissever01_00RBLFflipped_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_mar_Grid.png".format(attr_value),
        evalPath + "/apcatbr/mae_dissever01WIESMN_500_2018_ams_DasyA_apcatbr_p[1]_12AIL12_12IL_it10_mar_Grid.png".format(attr_value),
        #evalPath + "/apcnn/mae_dissever01_RMSEflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcnn/mae_dissever01_CLFflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcnn/mae_dissever01_00RBLFflipped_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcatbr/mae_dissever01WIESMN_500_2018_ams_DasyA_apcatbr_p[1]_12AIL12_12IL_it10_tur_Grid.png".format(attr_value)
        ]
    path = os.path.dirname(os.path.dirname(evalPath)) + "/ams_matrices/mae_LFunctions_mar.png".format(attr_value)
    title = "Mean Absolute Error: mar".format(attr_value)
    plotMatrix(e, path, title)
    
    e= [os.path.dirname(os.path.dirname(evalPath)) + "/{0}_GT/{0}_whole/{0}_GT_mar.png".format(city,attr_value),
        evalPath + "/apcnn/dissever01_RMSEflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_mar.png".format(attr_value),
        evalPath + "/apcnn/dissever01_CLFflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_mar.png".format(attr_value),
        evalPath + "/apcnn/dissever01_00RBLFflipped_2018_ams_Dasy_16unet_10epochspi_12AIL12_it10_mar.png".format(attr_value),
        evalPath + "/apcatbr/dissever01WIESMN_500_2018_ams_DasyA_apcatbr_p[1]_12AIL12_12IL_it10_mar.png".format(attr_value),
        #os.path.dirname(os.path.dirname(evalPath)) + "/{0}_GT/{0}_GT_tur.png".format(city,attr_value),
        #evalPath + "/apcnn/dissever01_RMSEflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcnn/dissever01_CLFflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcnn/dissever01_RMSEflipped_2018_ams_Dasy_16unet_10epochspi_AIL12_it10_tur_Grid.png".format(attr_value),
        #evalPath + "/apcatbr/dissever01WIESMN_500_2018_ams_DasyA_apcatbr_p[1]_12AIL12_12IL_it10_tur_Grid.png".format(attr_value)
        ]
    path = os.path.dirname(os.path.dirname(evalPath)) + "/ams_matrices/predictions_LFunctions_mar.png".format(attr_value)
    title = "Ground Truth & Predictions".format(attr_value)
    plotMatrix(e, path, title)
