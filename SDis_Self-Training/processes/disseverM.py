...
from models.caretML import fitM, predictM 
...
def runDissever(city, fshape, ancdatasets, attr_value, ROOT_DIR,group_split, yraster=None, rastergeo=None, 
                poly2agg = None, method='lm', p=[1], min_iter=3, max_iter=100, converge=2,
    ...
    for k in range(1, max_iter+1):
        ...
        mod = fitM(ancdatasets, disseverdatasetA, p, method,  ROOT_DIR, casestudy,city, group_split) 
        
        print('| -- Predicting new values')
        predictedmaps = predictM(mod, ancdatasets, attr_value)
